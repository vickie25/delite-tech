...
const ALL_PRODUCTS = [
  { id: 'p1', name: 'iPhone 17 Pro Max', price: 185000, originalPrice: 205000, img: '/src/assets/iphone 17 pro max.jpg', brand: 'Apple', spec: '256GB / 12GB RAM / Titanium', rating: 5, reviewsCount: 124, isNew: true, desc: 'The most powerful iPhone ever. Featuring a custom titanium chassis, the A19 Pro Bionic chip, and an advanced Triple-Lens camera system for professional-grade photography and video.', specs: ['6.7" Dynamic AMOLED', 'A19 Pro Bionic', '2TB Storage Max', '5G Ultra Wideband'] },
  { id: 'p2', name: 'MacBook Air M5', price: 195000, originalPrice: 220000, img: '/src/assets/macbook air m5.jpg', brand: 'Apple', spec: 'M5 / 16GB / 512GB', rating: 5, reviewsCount: 86, isSale: true, desc: 'Ultra-thin, ultra-powerful. The M5 chip brings unprecedented speed and efficiency to our most portable laptop.', specs: ['13.6" Liquid Retina', 'Apple M5 Chip', '24GB Unified Memory', '2TB SSD Max'] },
  { id: 'p3', name: 'ThinkPad X1 Carbon', price: 210000, img: '/src/assets/lenvovo think pad laptop.jpg', brand: 'Lenovo', spec: 'i7 / 32GB / 1TB', rating: 4, reviewsCount: 42, desc: 'The gold standard for business computing. Carbon-fiber reinforced chassis with legendary reliability and performance.', specs: ['14" 4K OLED', 'Intel Core Ultra 7', '64GB RAM', 'Windows 11 Pro'] },
  { id: 'p4', name: 'iPhone 16 Pro Max', price: 155000, originalPrice: 175000, img: '/src/assets/iphone 16 pro max.jpg', brand: 'Apple', spec: '128GB / 8GB RAM', rating: 5, reviewsCount: 512, isSale: true, desc: 'A major leap in battery life and camera performance. The iPhone 16 Pro Max is built for the professionals.', specs: ['6.7" Super Retina XDR', 'A18 Pro Chip', '48MP Main Camera', 'Titanium Design'] },
];
